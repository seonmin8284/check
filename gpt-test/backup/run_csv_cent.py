...
실행:
    .venv/Scripts/python.exe run_csv_b.py --input work.csv   --output work_out_cent.csv
...
company, sector, theme, market, index, metric, corporate_event, market_event, investor_group, product, account, procedure, regulation, document, app_feature
...
def main() -> int:
    ...
    p.add_argument("--output", default="work_out_cent.csv")
