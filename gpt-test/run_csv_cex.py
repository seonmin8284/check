...
실행:
    .venv/Scripts/python.exe run_csv_b.py --input work.csv   --output work_out_cex.csv
...
"및" 이 있어서 나눈 것이 아니라 수급과 주가가 서로 다른 근거라서 나눴다.## FORBIDDEN
...
def main() -> int:
    ...
    p.add_argument("--output", default="work_out_cex.csv")
